package sr.ice.evictor;

import Ice.ServantLocator;

//SOURCE: https://github.com/zeroc-ice/ice-demos/blob/master/java/Manual/evictor/EvictorBase.java
public abstract class EvictorBase implements ServantLocator {
    ...
    private java.util.Map<Ice.Identity, EvictorEntry> _map = new java.util.HashMap<Ice.Identity, EvictorEntry>();
    private sr.ice.evictor.LinkedList<Ice.Identity> _queue = new sr.ice.evictor.LinkedList<Ice.Identity>();
    private int _size;
}
